    ...
    def act(
        ...
        def aux_act_once(self):
            ...
            try:
                ...
                # 確保 content 包含必要的欄位，如果沒有則使用預設值
                if not isinstance(content, dict):
                    content = self._create_default_content()
                
                # 如果沒有 cognitive_state，添加預設值
                if "cognitive_state" not in content:
                    content["cognitive_state"] = {
                        "goals": ["Complete the current task successfully"],
                        "attention": "Focusing on the current context",
                ...
                if "action" not in content:
                    content["action"] = {
                        "type": "THINK",
                        "content": "Processing the current situation..."
                    }
                ...
                print(f"Error in aux_act_once: {str(e)}")
